...
// the Object
console.log(Object.values(numAnimals)[0])

// Add an animal to the zoo Object, and log the updated Object.
numAnimals.giraffes = 6
console.log(numAnimals.giraffes)

// Change the value for at least one of your animal keys, and log the updated Object.
numAnimals.tigers = 4
console.log(numAnimals.tigers)
// Add another animal to the zoo Object, and log the updated Object.
numAnimals.dragons = 1
console.log(numAnimals.dragons)
...
var emailArray = [
{
  ...
  },
  {
      sender: 'dylan',
      recipient: 'james',
      subject: 'you seen this?',
      body: 'He cannot be allowed to sabatage the order',
      attachments: 'https:somescandalousstuff.com'
    },
    {
        sender: 'james',
        recipient: 'layton',
        subject: 'check yourself',
        body: 'What the hell, bro',
        attachments: 'https:somescandalousstuff.com'
      }
]
